...
class WeaponFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        list.add(WFRecycler(context,
            R.drawable.pistol,
            "권총",
            arrayListOf("APB", "APS", "PL-15", "FN 5-7", "Glock 17", "Glock 18c", "M1911A1", "M45A1", "M9A3", "MP-443 \"Grach\"", "P226R", "PB pistol", "PM (t) pistol", "PM pistol", "SR-1MP Gyurza", "TT pistol", "TT pistol (gold)"),
        ...
        list.add(WFRecycler(context,
            R.drawable.melee,
            "근접 무기",
            arrayListOf("6h5 Bayonet", "Antique axe", "Bars A-2607-95x18", "Bars A-2607-Damascus", "Camper Axe", "Crash Axe", "ER Fulcrum Bayonet", "CrowBar", "Tactical Tomahawk", "M-2 Tactical Sword", "Cultists knife", "MPL-50", "Red Rebel Ice Pick", "SP-8 Machete", "UVSR Taiga-1"),
            arrayListOf(R.drawable.bayonet_6h5, R.drawable.antique_axe, R.drawable.a_2607_9, R.drawable.a_2607_d, R.drawable.camper_axe, R.drawable.crash_axe, R.drawable.er_bayonet, R.drawable.crowbar, R.drawable.tomahawk, R.drawable.m_2, R.drawable.cultist_knife, R.drawable.mpl_50, R.drawable.rr, R.drawable.sp_8, R.drawable.uvsr_taiga_1),  "meleeweapon"))
