    ...
    override fun onCreateView(
        ...
        list.add(
            WFRecycler(
                ...
                arrayListOf(R.drawable.asval, R.drawable.op_sks, R.drawable.sks, R.drawable.hunter),
                "weapon"
            )
        )
        ...
        list.add(
            WFRecycler(
                ...
                arrayListOf(
                    ...
                    R.drawable.mpx,
                    R.drawable.vector_9,
                    R.drawable.vector_45,
                    R.drawable.ump_45,
                    R.drawable.p90,
                    R.drawable.vityza_sn,
                    R.drawable.klin,
                    R.drawable.kedr,
                    R.drawable.kedr_b,
                    R.drawable.ppsh_41,
        ...
        list.add(
            WFRecycler(
                ...
                arrayListOf(
                    R.drawable.bayonet_6h5,
                    R.drawable.antique_axe,
                    R.drawable.a_2607_9,
                    R.drawable.a_2607_d,
                    R.drawable.camper_axe,
                    R.drawable.crash_axe,
                    R.drawable.er_bayonet,
                    R.drawable.crowbar,
                    R.drawable.tomahawk,
                    R.drawable.m_2,
                    R.drawable.cultist_knife,
                    R.drawable.mpl_50,
                    R.drawable.rr,
                    R.drawable.sp_8,
                    R.drawable.uvsr_taiga_1
                ), "meleeweapon"
            )
        )
...
class WFAdapter(private val items: ArrayList<WFRecycler>) :
    ...
    class ViewHolder(v: View) : RecyclerView.ViewHolder(v) {
        ...
        fun bind(item: WFRecycler) {
            ...
            view.ammo_menu.addItemDecoration(
                DividerItemDecoration(
                    item.context,
                    DividerItemDecoration.VERTICAL
                )
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflatedView =
            LayoutInflater.from(parent.context).inflate(R.layout.ammo_list, parent, false)
