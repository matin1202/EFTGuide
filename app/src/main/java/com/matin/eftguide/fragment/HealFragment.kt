    ...
    override fun onCreateView(
        ...
        list.add(
            RecyclerAmmo(
                ...
                arrayListOf(R.drawable.icon_combat_stimulant_sj1, R.drawable.icon_etg_change, R.drawable.icon_combat_stimulant_sj6, R.drawable.icon_propital, R.drawable.icon_hemostatic_drug_zagustin, R.drawable.icon_adrenaline, R.drawable.icon_meldonin, R.drawable.icon_ahf1_m, R.drawable.icon_3_b_tg, R.drawable.icon_l1_norepinephrine, R.drawable.icon_p22, R.drawable.icon_cocktail_obdolbos, R.drawable.icon_mule_stimulator, R.drawable.icon_xtg_12, R.drawable.icon_combat_stimulant_sj9),
                context!!, "stimulator")
        )
